...
Frontend - React Native mobile application, preventative care dashboard
Backend - Process user entered information, creates personalized recommendations
Database - Stores user profiles and history with a cloud storage

## Setup Instructions
1. Clone the repo
git clone https://github.com/loganphan1/PreventativePlanner.git
2. Build project
type "npm run build" into terminal
3. Run project
